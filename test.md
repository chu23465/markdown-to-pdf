GitHub served me with a takedown request. I am not in any position to counter nor do I have the time or energy to maintain this repo as college is going in full swing. Take your backups. Forks of VT-PR were not included in the DMCA. 


# VineTrimmer PlayReady

[![Made Python][python-shield]][python-url]
[![Forks][forks-shield]][forks-url]
[![Stargazers][stars-shield]][stars-url]
[![project_license][license-shield]][license-url]
[![issue_close][issues-shield]][issues-url]

<img height="30" src="https://git.gay/chu23465/VT-PR/raw/branch/dev/assets/icon_transparent.png"> 
...
-->
<img src="https://git.gay/chu23465/VT-PR/raw/branch/dev/assets/screenshot.png">

[python-url]: https://www.python.org/
[python-shield]: https://img.shields.io/badge/Made%20with-python-blue?style=for-the-badge&logo=python
[issues-shield]: https://img.shields.io/github/issues-closed/chu23465/VT-PR.svg?style=for-the-badge&color=green
[issues-url]: https://github.com/chu23465/VT-PR/issues?q=is%3Aissue%20state%3Aclosed
[forks-shield]: https://img.shields.io/github/forks/chu23465/VT-PR.svg?style=for-the-badge&color=maroon
[forks-url]: https://github.com/chu23465/VT-PR/network/members
[stars-shield]: https://img.shields.io/github/stars/chu23465/VT-PR.svg?style=for-the-badge&color=teal
[stars-url]: https://github.com/chu23465/VT-PR/stargazers
[license-shield]: https://img.shields.io/github/license/chu23465/VT-PR.svg?style=for-the-badge&color=indigo
[license-url]: https://github.com/chu23465/VT-PR/blob/master/LICENSE.txt
...
Refer to [#87](https://github.com/chu23465/VT-PR/issues/87). I recommend temporarily using [this](https://github.com/DevLARLEY/PlayreadyProxy2).

## This project is under active development. Expect bugs and errors.

I have recently started University. Please bear with me as I am a lot more busy now. Expect updates on weekends. If anyone is interested in contributing and/or closing issues please contact me `@achu2345678` on Telegram or `@crapola` on Discord. 
...
8. For cookies, always extract from homepage of (streaming) service using [Get cookies.txt LOCALLY](https://chrome.google.com/webstore/detail/get-cookiestxt-locally/cclelndahbckbenkjhflpdbgdldlbecc). The old `open-cookies.txt`extension is not ManifestV3 compliant and the source code has been removed from github and the extension javascript obfuscated. Remove it.

9. Save cookies to desired folder. Folder name should be `Cookies/{full_service_name}`. As in `Cookies/ParamountPlus` instead of `Cookies/PMTP`. Pay attention to the path if you are on Linux. Path is case sensitive.
